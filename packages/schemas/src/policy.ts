...
export const PolicyInput = z
  .object({
    ...
    isTokenApproval: z.boolean().optional(),
    tokenApprovalAmount: z.string().nullable().optional(),
    tokenApprovalAmountMissing: z.boolean().optional(),
    tokenApprovalUnlimited: z.boolean().optional(),
    tokenApprovalAmountExceedsCap: z.boolean().optional(),
